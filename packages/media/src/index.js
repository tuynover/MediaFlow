...
class MediaProcessor {
    ...
    static parseProbeData(probeJson, sizeBytes) {
    ...
    static getThumbnailArgs(inputPath, outputPath) {
    ...
    static getTranscodeArgs(inputPath, outputPath, targetHeight) {
    ...
    static parseProgressLine(line, totalDurationMs) {
